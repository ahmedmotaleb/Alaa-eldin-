...
const ACTION_LABEL: Record<string, string> = {
  ...
  supplier_return_created: 'إنشاء مرتجع مورد',
  supplier_return_approved: 'الموافقة على مرتجع مورد',
  supplier_return_sent: 'إرسال مرتجع للمورد',
  supplier_return_completed: 'اكتمال مرتجع مورد',
  supplier_return_cancelled: 'إلغاء مرتجع مورد',
  return_created: 'طلب مرتجع عميل',
  return_approved: 'الموافقة على مرتجع عميل',
  return_received: 'استلام مرتجع عميل',
  return_restocked: 'إرجاع صنف للمخزون',
